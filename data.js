...
const sleepDuaas = [
  {
    label: "In Your name, my Lord, I lie down and rise.",
    count: "1x",
...
وَبِكَ أَرْفَعُهُ`,
  ...
  {
    label: "O Allah, protect me from Your punishment on the Day You resurrect Your servants.",
    count: "3x",
...
يَوْمَ تَبْعَثُ عِبَادَكَ`,
  ...
  {
    label: "In Your name, O Allah, I die and I live.",
    count: "1x",
...
window.DUAA_COLLECTIONS = {
  morning: {
    ...
    bannerImages: ['assets/images/collections/morning-adhkar-banner.svg', 'assets/images/collections/morning-adhkar.png'],
    items: morningDuaas || []
  },
  evening: {
    id: 'evening',
    ...
    shortTitle: 'Evening',
    icon: '◒',
    iconImage: 'assets/images/collections/evening-icon.png',
    hasTracker: true,
    ...
    bannerImages: ['assets/images/collections/evening-adhkar.png'],
    items: eveningDuaas || []
  },
  sleep: {
    id: 'sleep',
    ...
    bannerImages: ['assets/images/collections/sleep.png'],
    items: sleepDuaas || []
  },
  travel: {
    id: 'travel',
    ...
    bannerImages: ['assets/images/collections/travel-banner.png'],
    items: travelDuaas || []
  },
  weather: {
    id: 'weather',
    ...
    bannerImages: ['assets/images/collections/weather-banner.png'],
  ...
  prayer: {
    ...
    bannerImages: ['assets/images/collections/prayer-banner.png'],
    items: prayerDuaas || []
  },
  istikharah: {
    id: 'istikharah',
